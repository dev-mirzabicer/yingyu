...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        'bg-background group/calendar p-3 [--cell-size:theme(spacing.8)] [[data-slot=card-content]_&]:bg-transparent [[data-slot=popover-content]_&]:bg-transparent', // <-- Corrected
